...
| P1 | Fit for readability without zoom-driven relayout | ZORA | Implemented in owner [PR #495](https://github.com/ankhorage/zora/pull/495), not yet released/integrated: opt-in label-size bounds and explicit, bounded spacing compaction. Ordinary zoom never reruns layout. Publication and browser acceptance pending. |
