...
export function ToggleSwitch({ ariaLabel, id, onToggle, value }: ToggleSwitchProps) {
  return (
    <Switch.Root
      aria-label={ariaLabel}
      className="relative h-[18px] w-[42px] shrink-0 cursor-default rounded-full bg-neutral-200 outline-none data-[state=checked]:bg-neutral-200 dark:bg-neutral-800 dark:data-[state=checked]:bg-gray-700"
      id={id}
      checked={value}
