...
// node_modules/@ankhorage/surface/src/utils/resolveSpacing.ts
function resolveSpacing(theme, value) {
  return resolveToken(theme.spacing, value);
}

// node_modules/@ankhorage/surface/src/utils/resolveViewStyles.ts
function resolveViewStyles(theme, breakpoint, props) {
  return {
    elevation: 0,
...
function resolveSpacingStyles(theme, breakpoint, props) {
  return {
...
function resolveVisualStyles(theme, breakpoint, props) {
  return {
...
function resolveDimensionStyles(theme, breakpoint, props) {
  return {
...
function resolveLayoutStyles(breakpoint, props) {
  return {
...
function resolveRadius(theme, value) {
  return resolveToken(theme.radii, value);
}
function resolveColor(theme, value) {
  return resolveToken(theme.colors, value);
}
function resolveDimension(theme, value) {
  return resolveToken(theme.spacing, value);
}

export { resolveSpacing, resolveViewStyles };
