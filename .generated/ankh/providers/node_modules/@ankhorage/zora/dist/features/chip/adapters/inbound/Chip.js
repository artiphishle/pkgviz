...
function ChipInner({ themeId: _themeId, mode: _mode, testID, children, icon, selected = false, disabled = false, color = 'neutral', size = 's', interactionPolicy, onPress, }) {
    ...
    const renderContent = (state) => {
        ...
        return (<View bg={colors.backgroundColor} borderColor={colors.borderColor} borderWidth={1} px={padding.px} py={padding.py} radius="full" style={{
