...
function ToolbarInner({ themeId: _themeId, mode: _mode, interactionPolicy, children, floating = false, compact = true, testID, }) {
    return (<Card compact={compact} interactionPolicy={interactionPolicy} tone={floating ? 'default' : 'subtle'} testID={testID}>
