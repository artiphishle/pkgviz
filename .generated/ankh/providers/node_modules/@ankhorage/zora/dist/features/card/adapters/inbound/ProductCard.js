    ...
    return (<Card onPress={isInteractive ? onPress : undefined} interactionPolicy={interactionPolicy} {...rest}>
      <View gap="m">
        ...
        <View gap="s">
          ...
          {badges && badges.length > 0 ? (<View direction="row" gap="xs" wrap="wrap">
        ...
        {hasMeta ? (<View gap="xs">
            <Divider />
            {meta.map((item, index) => (<View direction="row" key={`${item.label}-${index}`} justify="space-between">
