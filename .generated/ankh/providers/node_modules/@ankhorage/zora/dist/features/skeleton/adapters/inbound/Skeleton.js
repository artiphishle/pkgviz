...
function SkeletonInner({ themeId: _themeId, mode: _mode, testID, width = '100%', height = 16, radius = 'm', }) {
    ...
    return (<View accessibilityLabel="Loading" accessibilityRole="text" bg={theme.semantics.neutral.surfaceHover} height={height} radius={radius} testID={testID} width={width} style={{ opacity: 0.72 }}/>);
}
/***
