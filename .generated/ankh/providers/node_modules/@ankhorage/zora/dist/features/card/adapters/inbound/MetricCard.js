...
function MetricCardInner({ themeId: _themeId, mode: _mode, interactionPolicy, testID, label, value, description, icon, delta, deltaColor = 'neutral', actions, tone = 'default', compact = false, onPress, }) {
        ...
        <View direction="row" align="flex-start" gap="m" justify="space-between">
          <View flex={1} gap="xs">
            <View direction="row" align="center" gap="xs" wrap="wrap">
              ...
              {delta != null ? (<Badge variant={badgeRecipe.variant} size={badgeRecipe.size} color={badgeRecipe.color}>
                  {delta}
                </Badge>) : null}
            </View>
