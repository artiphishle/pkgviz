 ...
 */
export function createGraphLoopSizer(cy) {
    ...
    function update() {
        ...
        cy.batch(() => {
            loops.forEach((edge) => {
                ...
                const clearance = Math.max(16, edge.width() * Number.parseFloat(String(edge.style('arrow-scale'))) * 2);
...
//# sourceMappingURL=createGraphLoopSizer.js.map