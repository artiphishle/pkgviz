...
function DatePickerInner({ themeId: _themeId, mode: _mode, ...props }) {
    ...
    const openPicker = React.useCallback(() => {
        if (props.interactionPolicy === 'passive')
            return;
        present({
            content: (<DatePickerContent description={props.description} interactionPolicy={props.interactionPolicy} label={props.label} maxDate={props.maxDate} minDate={props.minDate} onDismiss={dismiss} onSelect={(date) => {
...
//# sourceMappingURL=DatePicker.native.js.map