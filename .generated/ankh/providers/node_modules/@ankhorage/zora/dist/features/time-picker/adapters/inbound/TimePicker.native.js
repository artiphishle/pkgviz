...
function TimePickerInner({ themeId: _themeId, mode: _mode, ...props }) {
    ...
    const openPicker = React.useCallback(() => {
        if (props.interactionPolicy === 'passive')
            return;
        present({
            content: (<TimePickerContent description={props.description} formatTime={props.formatTime} interactionPolicy={props.interactionPolicy} label={props.label} maxTime={props.maxTime} minTime={props.minTime} onDismiss={dismiss} onSelect={(time) => {
...
//# sourceMappingURL=TimePicker.native.js.map