...
function MissingElementInner({ themeId: _themeId, mode: _mode, interactionPolicy: _interactionPolicy, requestedCapability, reason, evidenceId, minimumWidth, minimumHeight, testID, }) {
    ...
    return (<View accessibilityLabel={accessibilityLabel} accessibilityRole="text" accessible bg={theme.semantics.warning.softBg} borderColor={theme.semantics.warning.base} borderWidth={1} minHeight={minimumHeight} minWidth={minimumWidth} p="m" radius="m" style={styles.root} testID={testID}>
      <View gap="xs">
