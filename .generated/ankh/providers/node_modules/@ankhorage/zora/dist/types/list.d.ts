...
interface ListItemBaseProps extends ZoraBaseProps, Pick<SurfaceListItemProps, 'compact' | 'disabled' | 'leading' | 'selected' | 'trailing'> {
...
export type ListItemProps = ListItemBaseProps & (ListItemPressableProps | ListItemActionProps | ListItemStaticProps);
