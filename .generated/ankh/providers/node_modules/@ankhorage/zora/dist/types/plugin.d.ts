...
export type ZoraPluginCompositionErrorCode = 'duplicate-component' | 'duplicate-package' | 'invalid-component-meta' | 'invalid-interaction-policy-component' | 'invalid-placement-child' | 'invalid-placement-parent' | 'missing-component-meta' | 'missing-runtime-component';
