import type { ColorContrastContext, ColorHarmony, ColorSelectionTarget, ColorSwatchSelectionResult, ColorSwatchTiePolicy, GeneratedThemeModeColors, GeneratedThemeSwatches } from '@ankhorage/color-theory';
...
export type ZoraThemeCompilationDiagnosticCode = 'generated-output-divergence' | 'missing-target-swatch' | 'unresolved-selection-target';
