...
export function resolveButtonColors(theme, { variant, color, state, }) {
    if (state.disabled) {
        return {
...
export function resolveInputColors(theme, fieldState) {
...
//# sourceMappingURL=resolveInteractiveColors.js.map