...
export function Popover(props) {
    ...
    return (<>
      ...
      {resolvedOpen ? (<PopoverOverlay anchorRef={anchorRef} closeOnOutsidePress={props.closeOnOutsidePress ?? true} offset={props.offset ?? 8} onClose={close} passive={passive} placement={props.placement ?? 'bottom-start'} testID={props.testID}>
          {props.children}
        </PopoverOverlay>) : null}
    </>);
}
