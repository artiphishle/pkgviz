...
export function useToastRuntime(defaultDuration) {
    ...
    const controller = React.useMemo(() => ({ dismissToast, showToast }), [dismissToast, showToast]);
...
//# sourceMappingURL=useToastRuntime.js.map