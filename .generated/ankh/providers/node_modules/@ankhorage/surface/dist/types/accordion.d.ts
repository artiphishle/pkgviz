...
export interface AccordionTriggerProps extends Omit<PressableProps, 'accessibilityRole' | 'accessibilityState' | 'children' | 'disabled' | 'onPress'>, InteractionPolicyProps {
