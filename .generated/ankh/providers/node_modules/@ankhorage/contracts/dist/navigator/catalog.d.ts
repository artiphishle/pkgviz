import type { HeadlessTabsPresentation, JavaScriptTabsPresentation, NavigatorPreset, NavigatorType, StackPresentation } from '../navigator';
import type { NavigatorDependencyRequirement } from './generation';
import type { NavigatorApiStability, NavigatorCapabilityId, NavigatorRuntimePlatform, NavigatorSupportStatus } from './planning';
export type NavigatorVerificationKind = 'structural' | 'generation' | 'format' | 'lint' | 'dependency' | 'typescript' | 'install' | 'build' | 'export' | 'browser' | 'simulator' | 'device';
...
export type NavigatorPresentation = StackPresentation | HeadlessTabsPresentation | JavaScriptTabsPresentation | 'two-column' | 'three-column';
