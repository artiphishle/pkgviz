...
export declare const STACK_PRESENTATIONS: readonly ["card", "modal", "transparentModal", "containedModal", "containedTransparentModal", "fullScreenModal", "formSheet"];
export type StackPresentation = (typeof STACK_PRESENTATIONS)[number];
export declare const JAVASCRIPT_STACK_PRESENTATIONS: readonly ["card", "modal", "transparentModal"];
...
export declare const DRAWER_POSITIONS: readonly ["left", "right"];
export type DrawerPosition = (typeof DRAWER_POSITIONS)[number];
export declare const DRAWER_TYPES: readonly ["front", "back", "slide", "permanent"];
...
export type NavigatorNode = CustomNavigatorNode | DrawerNavigatorNode | SlotNavigatorNode | SplitViewNavigatorNode | StackNavigatorNode | TabsNavigatorNode;
