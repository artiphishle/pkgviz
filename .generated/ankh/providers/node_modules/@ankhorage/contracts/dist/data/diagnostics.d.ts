...
export type DataDiagnosticCode = 'ambiguous-server' | 'duplicate-operation-id' | 'invalid-config' | 'missing-adapter' | 'missing-api' | 'missing-credential' | 'missing-data-source' | 'missing-endpoint' | 'missing-operation' | 'missing-schema' | 'network-error' | 'parse-error' | 'unsupported-auth-scheme' | 'unsupported-schema' | (string & {});
