...
export type ReleaseObservedTargetState = ReleaseObservedWebState | ReleaseObservedAndroidState | ReleaseObservedIosState;
...
export type ReleaseStepOperation = 'prepare' | 'build' | 'publish' | 'sync-notes' | 'submit-review' | 'release' | 'rollout' | 'verify' | 'record';
...
export interface DeploymentReleaseAdapter {
    ...
    inspectAsync(request: ReleaseInspectionRequest): Promise<DeploymentProviderResult<ReleaseObservedNativeState>>;
...
//# sourceMappingURL=deployRelease.d.ts.map