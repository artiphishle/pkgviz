import type { DeploymentCredentialReference, DeploymentProviderResult, DeploymentSecretResolver, DeploymentStoreIdentity } from './deployProvider.js';
export type StoreListingTarget = 'android' | 'ios';
export type StoreListingField = 'name' | 'summary' | 'description' | 'keywords' | 'promotionalText' | 'supportUrl' | 'marketingUrl' | 'privacyPolicyUrl' | 'promoVideoUrl';
...
export interface DeploymentStoreListingAdapter {
    readonly target: StoreListingTarget;
    inspectAsync(context: StoreListingAdapterContext): Promise<DeploymentProviderResult<StoreListingTargetState>>;
    syncAsync(request: StoreListingSyncRequest): Promise<DeploymentProviderResult<StoreListingTargetState>>;
}
//# sourceMappingURL=deployStoreListing.d.ts.map