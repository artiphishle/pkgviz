...
export interface MonetizationPlanStep {
    ...
    readonly target: 'android' | 'ios';
    readonly productId: string;
    readonly operation: 'ensure-subscription-family' | 'create-product' | 'update-metadata' | 'update-price' | 'update-subscription';
}
...
export interface DeploymentMonetizationAdapter {
    readonly target: 'android' | 'ios';
    inspectAsync(context: MonetizationAdapterContext): Promise<DeploymentProviderResult<MonetizationTargetState>>;
    syncAsync(request: MonetizationSyncRequest): Promise<DeploymentProviderResult<MonetizationTargetState>>;
}
//# sourceMappingURL=deployMonetization.d.ts.map