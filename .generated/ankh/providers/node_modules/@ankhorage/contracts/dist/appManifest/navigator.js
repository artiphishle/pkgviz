...
import { isDrawerNavigatorOptions, isNavigatorScreenReference, isStackImplementationConfig, isStackScreenOptions, isTabsImplementationConfig, } from './navigatorOptions';
...
function hasNavigatorPreset(value) {
    return NAVIGATOR_PRESETS.includes(value);
}
/*** Check a serialized topology against the public contract without eager cyclic initialization. */
function hasNavigatorType(value) {
    return NAVIGATOR_TYPES.includes(value);
}
