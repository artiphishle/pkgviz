...
import { isAdapterRef, isCredentialRef, isDataEndpointRegistry, isDataSchemaRegistry, } from './data';
...
export function isDataSourceRegistry(value) {
...
function isDatabaseDataSource(value) {
    return (isRecord(value) &&
